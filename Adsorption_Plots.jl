...
T = 1.5;
ChemPot = -3.0;
p = plot(foreground_color_legend = false, legend = :topright, xlabel = "Slit Separation", ylabel= "< Density > [Unitless]", size = [1920, 1080])
...
for Percentage in Percentage_Array
    ...
    plot!(a.h, a.Density, yerror = a.ErrorDensity, width = 3, label = "$Percentage% Attractive Area")
end
